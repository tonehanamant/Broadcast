...
GO
CREATE NONCLUSTERED INDEX [IX_FK_plan_version_buying_parameters_plan_versions]
    ON [dbo].[plan_version_buying_parameters]([plan_version_id] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_FK_plan_version_buying_parameters_plan_version_buying_job]
    ON [dbo].[plan_version_buying_parameters]([plan_version_buying_job_id] ASC);
