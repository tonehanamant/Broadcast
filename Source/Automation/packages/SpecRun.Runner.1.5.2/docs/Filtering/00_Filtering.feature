...
Scenario: Display error if filter has a syntax error
	Given there is a specrun configuration file 'Default.srprofile' as
		"""
		<?xml version="1.0" encoding="utf-8"?>
		<TestProfile xmlns="http://www.specrun.com/schemas/2011/09/TestProfile">
			...
			<Filter>@tag1 &amp;&amp; @tag2</Filter>
		</TestProfile>
        """
	When I execute the console runner
	Then the console runner output should contain 'Configuration error: Invalid filter expression syntax (wrong argument count)'