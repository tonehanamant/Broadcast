...
namespace Services.Broadcast.IntegrationTests.UnitTests.ApplicationServices
{
    ...
    public class ProgramMappingServiceUnitTests
    {
        ...
        [Test]
        [UseReporter(typeof(DiffReporter))]
        public void RunProgramMappingsProcessingJob_ExcludeGenres()
        {
            ...
            //Master list from database
            _ProgramMappingRepositoryMock.Setup(m=> m.GetProgramsAndGeneresFromDataTable()).Returns(new List<ProgramMappingsDto>
            {
                new ProgramMappingsDto
                {
                     OfficialGenre = new Genre{ Name = "Sports" },
