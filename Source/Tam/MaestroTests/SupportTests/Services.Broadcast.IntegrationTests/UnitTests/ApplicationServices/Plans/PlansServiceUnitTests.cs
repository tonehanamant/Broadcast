...
namespace Services.Broadcast.IntegrationTests.UnitTests.ApplicationServices.Plans
{
    ...
    public class PlansServiceUnitTests
    {
        ...
        [Test]
        [UseReporter(typeof(DiffReporter))]
        public void CanGetPlan_GoalsByDaypart()
        {
            // Arrange
            var planToReturn = _GetNewPlanGoalsByDaypart();
            ...
            _StandardDaypartServiceMock
                .Setup(s => s.GetAllStandardDayparts())
                .Returns(_GetDaypartCodeDefaults());
            ...
            _WeeklyBreakdownEngineMock
                .Setup(x => x.GroupWeeklyBreakdownWeeksBasedOnDeliveryType(It.IsAny<PlanDto>(), It.IsAny<PlanDaypartGoalDto>()))
        ...
        private static PlanDto _GetNewPlanGoalsByDaypart()
        {
            return new PlanDto
            {
                CampaignId = 1,
        ...
        private static List<StandardDaypartDto> _GetDaypartCodeDefaults()
        {
            return new List<StandardDaypartDto>
            {
                new StandardDaypartDto { Id = 2, Code = "MDN" ,FullName = "Midday News", VpvhCalculationSourceType = VpvhCalculationSourceTypeEnum.AM_NEWS },
                new StandardDaypartDto { Id = 11, Code = "EMN" ,FullName = "Early Morning News", VpvhCalculationSourceType = VpvhCalculationSourceTypeEnum.AM_NEWS }
            };
        }
