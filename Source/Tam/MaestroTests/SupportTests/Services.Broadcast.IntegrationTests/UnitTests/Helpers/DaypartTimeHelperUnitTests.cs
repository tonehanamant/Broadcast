...
namespace Services.Broadcast.IntegrationTests.UnitTests.Helpers
{
    ...
    public class DaypartTimeHelperUnitTests
    {
        ...
        [TestCase(nameof(DaypartTimeHelper.AddOneSecondToEndTime), typeof(PlanCustomDaypartDto), nameof(PlanCustomDaypartDto.EndTimeSeconds), 400, 401)]
        [TestCase(nameof(DaypartTimeHelper.AddOneSecondToEndTime), typeof(PlanCustomDaypartDto), nameof(PlanCustomDaypartDto.EndTimeSeconds), BroadcastConstants.OneDayInSeconds - 1, 0)]
        [TestCase(nameof(DaypartTimeHelper.AddOneSecondToEndTime), typeof(PlanCustomDaypartDto), nameof(PlanCustomDaypartDto.EndTimeSeconds), 0, 1)]
        [TestCase(nameof(DaypartTimeHelper.AddOneSecondToEndTime), typeof(PlanCustomDaypartDto), nameof(PlanCustomDaypartDto.StartTimeSeconds), 400, 400)]
