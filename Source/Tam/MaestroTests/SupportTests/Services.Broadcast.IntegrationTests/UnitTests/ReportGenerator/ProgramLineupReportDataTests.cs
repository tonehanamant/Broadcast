...
namespace Services.Broadcast.IntegrationTests.UnitTests.ReportGenerator
{
    ...
    public class ProgramLineupReportDataTests
    {
        ...
        [Test]
        [TestCase("Contacts 2020", PostingTypeEnum.NSI, SpotAllocationModelMode.Quality, "Program_Lineup_Report_B_Contacts 2020_NSI_Q_10012020.xlsx")]
        [TestCase("Contacts 2020", PostingTypeEnum.NSI, SpotAllocationModelMode.Efficiency, "Program_Lineup_Report_B_Contacts 2020_NSI_E_10012020.xlsx")]
        [TestCase("Contacts 2020", PostingTypeEnum.NSI, SpotAllocationModelMode.Floor, "Program_Lineup_Report_B_Contacts 2020_NSI_F_10012020.xlsx")]
        [TestCase("Contacts 2020", PostingTypeEnum.NTI, SpotAllocationModelMode.Quality, "Program_Lineup_Report_B_Contacts 2020_NTI_Q_10012020.xlsx")]
        [TestCase("Contacts 2020", PostingTypeEnum.NTI, SpotAllocationModelMode.Efficiency, "Program_Lineup_Report_B_Contacts 2020_NTI_E_10012020.xlsx")]
        [TestCase("Contacts 2020", PostingTypeEnum.NTI, SpotAllocationModelMode.Floor, "Program_Lineup_Report_B_Contacts 2020_NTI_F_10012020.xlsx")]
        [TestCase("Q4'21 TDN SYN Pricing V3 :15 :30", PostingTypeEnum.NSI, SpotAllocationModelMode.Quality, "Program_Lineup_Report_B_Q4'21 TDN SYN Pricing V3 15 30_NSI_Q_10012020.xlsx")]
        [TestCase("Q4'21 TDN SYN Pricing V3 :15 :30", PostingTypeEnum.NSI, SpotAllocationModelMode.Efficiency, "Program_Lineup_Report_B_Q4'21 TDN SYN Pricing V3 15 30_NSI_E_10012020.xlsx")]
        [TestCase("Q4'21 TDN SYN Pricing V3 :15 :30", PostingTypeEnum.NSI, SpotAllocationModelMode.Floor, "Program_Lineup_Report_B_Q4'21 TDN SYN Pricing V3 15 30_NSI_F_10012020.xlsx")]
        [TestCase("Q4'21 TDN SYN Pricing V3 :15 :30", PostingTypeEnum.NTI, SpotAllocationModelMode.Quality, "Program_Lineup_Report_B_Q4'21 TDN SYN Pricing V3 15 30_NTI_Q_10012020.xlsx")]
        [TestCase("Q4'21 TDN SYN Pricing V3 :15 :30", PostingTypeEnum.NTI, SpotAllocationModelMode.Efficiency, "Program_Lineup_Report_B_Q4'21 TDN SYN Pricing V3 15 30_NTI_E_10012020.xlsx")]
        [TestCase("Q4'21 TDN SYN Pricing V3 :15 :30", PostingTypeEnum.NTI, SpotAllocationModelMode.Floor, "Program_Lineup_Report_B_Q4'21 TDN SYN Pricing V3 15 30_NTI_F_10012020.xlsx")]
        public void GetBuyingFileName(string planName, PostingTypeEnum postingType, SpotAllocationModelMode spotAllocationModelMode, string expectedFileName)
        {
            var testDate = new DateTime(2020, 10, 1);
            var reportData = new ProgramLineupReportData();

            var result = reportData._GetBuyingFileName(planName, postingType, spotAllocationModelMode, testDate);
