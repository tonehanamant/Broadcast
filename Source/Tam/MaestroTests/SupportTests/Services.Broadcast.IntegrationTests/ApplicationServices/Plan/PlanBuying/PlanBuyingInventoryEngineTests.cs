...
namespace Services.Broadcast.IntegrationTests.ApplicationServices.Plan.PlanBuying
{
    ...
    public class PlanBuyingInventoryEngineTests
    {
        ...
        public void GetInventoryForQuoteTest()
        {
            try
            {
                StubbedConfigurationWebApiClient.RunTimeParameters["ThresholdInSecondsForProgramIntersectInBuying"] = "100";
                ...
                using (new TransactionScopeWrapper())
                {
                    ...
                    var planBuyingInventoryEngine = IntegrationTestApplicationServiceFactory.GetApplicationService<IPlanBuyingInventoryEngine>();

                    var result = planBuyingInventoryEngine.GetInventoryForQuote(request);
            ...
            {
                StubbedConfigurationWebApiClient.RunTimeParameters["ThresholdInSecondsForProgramIntersectInBuying"] = "1800";
            }
        }
