...
{
    public interface IScxConverter : IApplicationService, IScheduleConverter
    {
    }
    public class ScxConverter : ScheduleConverterBase,IScxConverter
    {
        protected adx _RawScx;
        public ScxConverter(IDataRepositoryFactory broadcastDataRepositoryFactory,
        ...
        public override schedule Convert(ScheduleDTO scheduleDto)
        {
            ...
            _RawScx = adx.Deserialize(_ReadAndScrubScx(scheduleDto.FileStream));
        ...
        private string _ReadAndScrubScx(Stream scxStream)
        {
            ...
            var fileText = Encoding.UTF8.GetString(StreamHelper.ReadToEnd(scxStream));
