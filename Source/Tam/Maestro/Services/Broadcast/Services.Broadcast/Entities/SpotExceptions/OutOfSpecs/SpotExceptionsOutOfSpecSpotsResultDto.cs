...
{
    /// <summary></summary>
    public class SpotExceptionsOutOfSpecSpotsResultDto
    {
        /// <summary>Initializes a new instance of the 
        /// <see cref="SpotExceptionsOutOfSpecSpotsResultDto" /> class.</summary>
        public SpotExceptionsOutOfSpecSpotsResultDto()
        {
