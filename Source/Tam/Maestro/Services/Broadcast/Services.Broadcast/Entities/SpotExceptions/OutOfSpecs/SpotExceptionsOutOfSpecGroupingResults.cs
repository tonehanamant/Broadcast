...
{
    /// <summary></summary>
    public class SpotExceptionsOutOfSpecGroupingResults
    {
        /// <summary>
        /// Initializes a new instance of the 
        /// <see cref="SpotExceptionsOutOfSpecGroupingResults" /> class.</summary>
        public SpotExceptionsOutOfSpecGroupingResults()
        {
            Active = new List<SpotExceptionsOutOfSpecGroupingToDoResults>();
            Completed = new List<SpotExceptionsOutOfSpecGroupingDoneResults>();
        }
        ...
        public List<SpotExceptionsOutOfSpecGroupingToDoResults> Active { get; set; }

        /// <summary>
        /// Gets or sets the completed.
        /// </summary>
        /// <value>The completed.</value>
        public List<SpotExceptionsOutOfSpecGroupingDoneResults> Completed { get; set; }
    }

    /// <summary></summary>
    public class SpotExceptionsOutOfSpecGroupingToDoResults
    {
        /// <summary>
    ...
    /// <summary></summary>
    public class SpotExceptionsOutOfSpecGroupingDoneResults
    {
        /// <summary>
        /// Gets or sets the plan identifier.
        /// </summary>
