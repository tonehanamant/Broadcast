...
{
    public class BuyingSpotAllocationViewReportGenerator
    {
        ...
        internal void PopulateTab(ExcelWorksheet worksheet, BuyingResultsReportData reportData)
        {
        ...
        private void _PopulateHeaders(ExcelWorksheet worksheet, BuyingResultsReportData reportData)
        {
            worksheet.Cells[PLAN_ID_CELL].Value = reportData.PlanId;
            worksheet.Cells[PLAN_VERSION_CELL].Value = reportData.PlanVersion;
        }

        private void _PopulateTotals(ExcelWorksheet worksheet, BuyingResultsReportData reportData)
        {
