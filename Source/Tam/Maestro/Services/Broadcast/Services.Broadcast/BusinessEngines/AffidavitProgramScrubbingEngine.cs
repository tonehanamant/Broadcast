...
{
    public interface IAffidavitProgramScrubbingEngine : IApplicationService
    {
        void Scrub(ProposalDetailDto proposalDetail, AffidavitFileDetail affidavitDetail, AffidavitClientScrub scrub);
    }
    public class AffidavitProgramScrubbingEngine : IAffidavitProgramScrubbingEngine
    {
        private readonly int _BroadcastMatchingBuffer;

        public AffidavitProgramScrubbingEngine()
        {
            _BroadcastMatchingBuffer =  BroadcastServiceSystemParameter.BroadcastMatchingBuffer;
        }

        public void Scrub(ProposalDetailDto proposalDetail, AffidavitFileDetail affidavitDetail, AffidavitClientScrub scrub)
        {
