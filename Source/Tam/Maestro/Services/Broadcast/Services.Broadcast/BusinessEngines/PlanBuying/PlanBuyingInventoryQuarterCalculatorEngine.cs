...
{
    public interface IPlanBuyingInventoryQuarterCalculatorEngine
    {
    ...
    public class PlanBuyingInventoryQuarterCalculatorEngine : IPlanBuyingInventoryQuarterCalculatorEngine
    {
        private readonly IQuarterCalculationEngine _QuarterCalculationEngine;
        private readonly IMediaMonthAndWeekAggregateCache _MediaMonthAndWeekAggregateCache;

        public PlanBuyingInventoryQuarterCalculatorEngine(IQuarterCalculationEngine quarterCalculationEngine,
