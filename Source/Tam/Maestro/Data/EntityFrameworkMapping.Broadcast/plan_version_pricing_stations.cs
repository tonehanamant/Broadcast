...
namespace EntityFrameworkMapping.Broadcast
{
    ...
    public partial class plan_version_pricing_stations
    {
        public plan_version_pricing_stations()
        {
            this.plan_version_pricing_station_details = new HashSet<plan_version_pricing_station_details>();
        }
        ...
        public virtual ICollection<plan_version_pricing_station_details> plan_version_pricing_station_details { get; set; }
