          ...
          <Col>
            <Navbar.Collapse>
              <Nav>
                ...
                <NavItem componentClass={Link} href="/broadcastreact/post" to="/broadcastreact/post" active={this.props.routing.location.pathname === '/broadcastreact/post' || '/broadcastreact'}>Post</NavItem>
              </Nav>
            </Navbar.Collapse>
          </Col>
        </Row>
