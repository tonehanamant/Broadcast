...
export const SelectionProps = PropTypes.oneOf([SELECTION.MULTI, SELECTION.SINGLE, SELECTION.NONE]);

export const HocStateProps = PropTypes.objectOf(PropTypes.shape);

export const RowChildrenProps = PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.element), PropTypes.element]);
