...
class PricingGuideProprietary extends Component {
  constructor(props) {
    super(props);
...
PricingGuideProprietary.propTypes = {
...
PricingGuideProprietary.defaultProps = {
  activeOpenMarketData: {}
};

export default PricingGuideProprietary;
