...
class PricingGuideGridHeader extends Component {
  ...
  onOpenEditMarkets() {
    const { showEditMarkets } = this.props;
    showEditMarkets(true);
  }
  ...
  applyFilters(filterObject, isModal) {
    const { activeOpenMarketData, filterOpenMarketData } = this.props;
    ...
    filterOpenMarketData(filters);
  }

  sortMarket(sortKey) {
    const { sortOpenMarketData } = this.props;
    sortOpenMarketData(sortKey === "sortMarketName");
  }
