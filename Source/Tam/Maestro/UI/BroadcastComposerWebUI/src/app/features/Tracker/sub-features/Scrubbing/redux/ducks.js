...
export const TRACKER_OVERRIDE_STATUS = createAction(
  `${ROOT}/TRACKER_OVERRIDE_STATUS`
);
...
export default function reducer(state = initialState, action) {
  ...
  switch (type) {
    ...
    case TRACKER_OVERRIDE_STATUS.store:
      return {
        ...state,
        proposalHeader: {
          ...state.proposalHeader,
...
const getTrackerClientScrubbing = params => ({
...
const overrideStatus = params => ({
  type: TRACKER_OVERRIDE_STATUS.request,
  payload: params
});
