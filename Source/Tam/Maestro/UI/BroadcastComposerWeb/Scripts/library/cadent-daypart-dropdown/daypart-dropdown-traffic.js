...
; (function ($, window, document, undefined) {
    ...
    function dateToString(dateObj) {
        ...
        if (dateObj.StartTime != null && dateObj.EndTime != null) {
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            //$element.on("input", function (e) { // when the user click on the X button to clean the input
            ...
            //    var days = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"];
            //    days.forEach(toogleCheckbox.bind(null, false));
            //    $('#starttime').val('');
            //    $('#endtime').val('');
            //})
            ...
            $element.webuiPopover({
                ...
                width: this.settings.timePickerOnTop ? 200 : 300,
                ...
                content: function () {
                    ...
                    var timePickers = "";
                    timePickers += "<div class='time-pickers-container'>";
                    timePickers += "<input id='starttime' type='text' class='timepicker' />";
                    timePickers += "<span>to</span>";
                    timePickers += "<input id='endtime' type='text' class='timepicker' />";
                    timePickers += "</div>";

                    //LeftContainer
                    var additionalClass = _this.settings.timePickerOnTop ? "" : "daypart-left-container";
                    content += "<div class='" + additionalClass + "'>";
                    if (_this.settings.timePickerOnTop) {
                        content += timePickers;
                    }
                    //Custom options
        ...
        generateDateObject: function () {
            ...
            var startTimeSeconds = startTime && hourToSeconds(startTime.getHours(), startTime.getMinutes());
