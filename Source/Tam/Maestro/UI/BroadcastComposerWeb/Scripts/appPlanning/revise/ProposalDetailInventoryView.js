...
var ProposalDetailInventoryView = BaseView.extend({
   ...
   // ProposalView: null,
    ...
    //Revised  modal close event - added to distinguish between clear and hide modal and got to react proposal
    onHideInventory: function () {
        var proposalId = this.activeDetailSet.proposalId;
    ...
    getSaveItemsParams: function () {
        var detailId = this.activeDetailSet.detailId
        return {
    ...
    saveInventory: function (isApply, pendingParams) {
        ...
        this.PlanningController.apiSaveInventoryProprietary(params, function (response) {
    ...
    updateSummary: function () {
        ...
        var request = {
            ProposalDetailId: this.activeDetailSet.detailId,
        ...
        this.PlanningController.apiPostDetailTotals(request, function (response) {
