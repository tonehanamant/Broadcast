...
function CriteriaBuilderViewModel(inventoryView) {
    ...
    $scope.Open = function () {
        $scope.activeDetailId = $scope.InventoryView.activeDetailSet ? $scope.InventoryView.activeDetailSet.detailId : $scope.activeDetailId;
    ...
    $scope.Apply = function () {
        if ($scope.IsValid() && !$scope.IsProcessing()) {
            ...
            $scope.processRefineResponse = function (response) {
                $scope.InventoryView.storedOpenMarketInventory = response;
