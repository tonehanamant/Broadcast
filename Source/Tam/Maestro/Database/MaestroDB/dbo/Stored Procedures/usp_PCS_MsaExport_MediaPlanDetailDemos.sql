...
-- Description:	Used to populate MSA Export file "media_plan_detail_demos.txt"
-- =============================================
CREATE PROCEDURE [dbo].[usp_PCS_MsaExport_MediaPlanDetailDemos]
