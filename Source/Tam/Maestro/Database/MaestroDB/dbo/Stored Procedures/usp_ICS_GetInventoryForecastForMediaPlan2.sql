...
--				@inventory_details defines the specific set of data to filter the result by
-- =============================================
/*
	DECLARE @proposal_id INT = 66759
	...
	EXEC usp_ICS_GetInventoryForecastForMediaPlan @inventory_details, 0
*/
CREATE PROCEDURE [dbo].[usp_ICS_GetInventoryForecastForMediaPlan2]
...
BEGIN
    ...
    DECLARE @inventory_filter_dayparts TABLE (source_daypart_id INT NOT NULL, component_daypart_id INT NOT NULL, component_hours FLOAT NOT NULL, total_component_hours FLOAT NOT NULL, PRIMARY KEY (source_daypart_id ASC, component_daypart_id ASC));
