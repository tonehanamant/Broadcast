...
-- =============================================
/*
	DECLARE @network_id INT = 1					
	DECLARE @media_month_id SMALLINT = 408			
	EXEC usp_ICS_GetInventoryForecastForNetwork @network_id, @media_month_id
*/
CREATE PROCEDURE [dbo].[usp_ICS_GetInventoryForecastForNetwork]
