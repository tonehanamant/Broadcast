...
--				8/16/2016 - multiplied contracted subscribers by spot_lengths.delivery_multiplier and removed parameter @inventory_state_filter_code TINYINT
-- Description:	Returns reserved inventory specific to the media month specified
-- =============================================
/*
	DECLARE @media_month_id SMALLINT = 419
	EXEC usp_ICS_GetReservedProposalInventoryForMediaMonth @media_month_id,NULL,0
	EXEC usp_ICS_GetReservedProposalInventoryForMediaMonth @media_month_id,NULL,1
*/
CREATE PROCEDURE [dbo].[usp_ICS_GetReservedProposalInventoryForMediaMonth]
	@media_month_id INT,
