...
CREATE PROCEDURE [dbo].[usp_PCS_GetMediaPlanHistoryByAgencyAndAdvertiserAndProduct]
...
BEGIN
	...
	WHERE
		p.agency_company_id=@agency_company_id
		AND p.advertiser_company_id=@advertiser_company_id
