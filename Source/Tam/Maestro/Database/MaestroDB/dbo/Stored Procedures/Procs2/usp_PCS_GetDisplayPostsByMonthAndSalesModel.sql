...
-- =============================================
-- usp_PCS_GetDisplayPostsByMonthAndSalesModel 373,1
CREATE PROCEDURE [dbo].[usp_PCS_GetDisplayPostsByMonthAndSalesModel]
	@media_month_id INT,
	@sales_model_id INT
AS
BEGIN
	...
	WHERE
		dp.sales_model_id IN (SELECT id FROM dbo.udf_GetSalesModelsFromSalesModel(@sales_model_id))
