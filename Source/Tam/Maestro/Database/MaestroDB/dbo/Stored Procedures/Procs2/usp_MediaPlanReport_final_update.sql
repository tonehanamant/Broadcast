...
--exec usp_MediaPlanReport_final_update 21093,31,248

CREATE procedure [dbo].[usp_MediaPlanReport_final_update]
(
	@ProposalId int
)
AS
BEGIN
	...
	SET @audience_id31 = (SELECT audience_id FROM proposal_audiences WHERE ordinal=0 AND proposal_id=@ProposalId)
	SET @audience_id248 = (SELECT audience_id FROM proposal_audiences WHERE ordinal=1 AND proposal_id=@ProposalId)
	...
	(
		...
		[percentage_31] [numeric](18, 0) NULL,
		[status_31] [varchar](1) NOT NULL,
		[id_31] [int] NOT NULL,
	...
	exec	usp_MediaPlanReport2_update @ProposalId,@audience_id31 
	...
	(
		...
		[percentage_248] [numeric](18, 0) NULL,
		[status_248] [varchar](1) NOT NULL,
		[id_248] [int] NOT NULL,
	...
	exec	usp_MediaPlanReport2_update @ProposalId,@audience_id248 
	
--	SELECT * FROM @MediaPlanReport_Aid31
--	SELECT * FROM @MediaPlanReport_Aid248
