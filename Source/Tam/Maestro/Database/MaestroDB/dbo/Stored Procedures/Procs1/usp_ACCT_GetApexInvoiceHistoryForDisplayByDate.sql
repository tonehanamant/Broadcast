...
-- Description:	Gets receivable invoice universe records for Apex by to and from date and effective date
-- Usage: exec dbo.usp_ACCT_GetApexInvoiceHistoryForDisplayByDate 6, 2011, 6, 2011, '05/01/2012'
-- =============================================
CREATE PROCEDURE [dbo].[usp_ACCT_GetApexInvoiceHistoryForDisplayByDate]
	 @from_month int
	,@from_year int 
	,@to_month int
	,@to_year int
