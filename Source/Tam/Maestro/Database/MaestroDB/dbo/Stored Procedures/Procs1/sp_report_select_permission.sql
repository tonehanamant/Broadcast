--exec [dbo].[sp_report_select_permission]
--select * from dbo.account_statuses
--exec dbo.usp_account_statuses_select 1

CREATE PROCEDURE [dbo].[sp_report_select_permission]
as
...
--execute commands
exec [dbo].[sp_refresh_run] 'Grant report)select select permission'
