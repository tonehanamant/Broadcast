...
-- Create date: 
-- Modified:	1/19/2011
-- Description:	Returns inactive zone errors for the specified media month.
-- Changes:		
-- =============================================
-- usp_ACS_GetRejectAffidavitsWithFileInfo_InActiveZone 360,NULL,NULL
CREATE PROCEDURE [dbo].[usp_ACS_GetRejectAffidavitsWithFileInfo_InActiveZone]
	@media_month_id INT,
	@business_id INT,
	@system_id INT
AS
