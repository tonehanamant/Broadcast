...
-- Description:	
-- =============================================
-- usp_BRS_GetDiplayCmwTrafficInvoicesByCmwInvoiceId 2919
CREATE PROCEDURE [dbo].[usp_BRS_GetDiplayCmwTrafficInvoicesByCmwInvoiceId]
	@cmw_invoice_id INT
AS
BEGIN
	...
	FROM
		...
		JOIN cmw_invoice_details cid (NOLOCK)			ON cid.cmw_traffic_id=ISNULL(ct.original_cmw_traffic_id,ct.id) AND cid.cmw_invoice_id=@cmw_invoice_id
