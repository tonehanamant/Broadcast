...
-- Description:	
-- =============================================
-- usp_REL_GetTrafficClearanceFactorBySpotLength 34420, getdate()
CREATE PROCEDURE [dbo].[usp_REL_GetTrafficClearanceFactorBySpotLength]
	@traffic_id INT,
...
BEGIN
	...
	SELECT
		ISNULL(CAST(slm.map_value AS FLOAT), 1.0)
	FROM
