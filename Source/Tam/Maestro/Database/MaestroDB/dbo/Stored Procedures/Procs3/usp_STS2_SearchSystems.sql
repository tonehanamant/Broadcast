...
*****************************************************************************************************/
-- exec [usp_STS2_SearchSystems2] 'O', '5/5/2009'
CREATE PROCEDURE [dbo].[usp_STS2_SearchSystems]
	@search_text VARCHAR(MAX),
	@effective_date DATETIME
AS
BEGIN
	--DECLARE
	--	@search_text VARCHAR(MAX) = 'O',
	...
	INSERT INTO @all_systems
		...
		WHERE
			...
			AND (code LIKE @search_text OR name LIKE @search_text)
