...
-- =============================================
/*
	EXEC usp_ICS_GetReservedProposalInventoryForMediaPlanByProposalId 73475,1
	EXEC usp_ICS_GetReservedProposalInventoryForMediaPlanByProposalId 73475,0
*/
CREATE PROCEDURE [dbo].[usp_ICS_GetReservedProposalInventoryForMediaPlanByProposalId]
	@proposal_id INT,
...
BEGIN
	...
	INSERT INTO @proposals_on_avail_planner
		...
		WHERE
			(p.include_on_availability_planner=1 OR p.id=@proposal_id) -- only proposals explicitly put on the avail planner + the proposal passed in
