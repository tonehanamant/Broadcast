...
-- Create date: 9/15/2009
-- Description:   
-- =============================================
-- SELECT * FROM dbo.GetSystemsByTopographyAndDate(1, '9/15/2009')
CREATE FUNCTION [dbo].[GetSystemsByTopographyAndDate]
(     
      @topography_id INT,
...
BEGIN
      INSERT INTO @systems
            ...
            FROM
                  ...
                  JOIN uvw_system_universe sz (NOLOCK) ON sz.system_id=szu.system_id
            WHERE
