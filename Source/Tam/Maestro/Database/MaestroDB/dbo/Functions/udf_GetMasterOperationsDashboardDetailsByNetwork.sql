...
-- Create date: 7/22/2015
-- Description:	Identical to the original routine: udf_GetMasterOperationsDashboardDetails except it returns results by network_id.
-- =============================================
-- SELECT * FROM tam_post_proposals WHERE tam_post_id=1002467
-- SELECT * FROM proposal_audiences WHERE proposal_id=51081
-- SELECT * FROM dbo.udf_GetMasterOperationsDashboardDetailsByNetwork(1003670,60075,NULL)
CREATE FUNCTION [dbo].[udf_GetMasterOperationsDashboardDetailsByNetwork]
(
	@tam_post_id INT,
	@proposal_id INT,
	@audience_id INT
