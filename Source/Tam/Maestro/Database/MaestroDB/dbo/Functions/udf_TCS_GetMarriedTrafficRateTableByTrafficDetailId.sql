-- SELECT * FROM traffic_details WHERE traffic_id=37977
-- SELECT * FROM dbo.udf_TCS_GetMarriedTrafficRateTable(37977)
-- SELECT * FROM dbo.udf_TCS_GetMarriedTrafficRateTableByTrafficDetailId(453352)
-- MAY NEED TWEAKING
CREATE FUNCTION [dbo].[udf_TCS_GetMarriedTrafficRateTableByTrafficDetailId]
(
