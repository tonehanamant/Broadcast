CREATE TABLE [dbo].[daily_inventory_forecast_details] (
    ...
    CONSTRAINT [PK_daily_inventory_forecast_details] PRIMARY KEY CLUSTERED ([media_month_id] ASC, [media_week_id] ASC, [network_id] ASC, [component_daypart_id] ASC, [hh_eq_cpm_start] ASC, [hh_eq_cpm_end] ASC, [proposal_id] ASC, [proposal_detail_id] ASC) ON [MediaMonthSmallintScheme] ([media_month_id])
);
