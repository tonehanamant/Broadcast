CREATE TABLE [dbo].[daily_traffic_inventory_forecast_details_staging] (
    ...
    CONSTRAINT [PK_daily_traffic_inventory_forecast_details_staging] PRIMARY KEY CLUSTERED ([media_month_id] ASC, [media_week_id] ASC, [business_id] ASC, [network_id] ASC, [component_daypart_id] ASC, [hh_eq_cpm_start] ASC, [hh_eq_cpm_end] ASC, [traffic_id] ASC, [traffic_spot_target_id] ASC) ON [MediaMonthSmallintScheme] ([media_month_id])
);
