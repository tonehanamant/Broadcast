CREATE PROCEDURE [dba].[spIndex_rebuild_daily]
@frag_set int,
@Date_Diff int,
@Row_Diff INT,
@index_no int 
...
--select * from temp_db_backup.dbo.temp_reindex_daily
...
FOR  SELECT * FROM temp_db_backup.dbo.temp_reindex_daily1;
