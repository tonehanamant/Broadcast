...
create PROCEDURE [dba].[sp_report_permission]
@role varchar(100),
@delete int 
as
...
begin
	...
	--execute commands
	exec [dba].[sp_refresh_run] 'grant reportsa'
end
...
begin
	...
	--execute commands
	exec [dba].[sp_refresh_run] 'revoke report_select'
	...
	--execute commands
	exec [dba].[sp_refresh_run] 'grant report_select'
end
...
begin
	...
	--execute commands
	exec [dba].[sp_refresh_run] 'revoke report_qa_test'
...
--	print @string_
	...
	--execute commands
	exec [dba].[sp_refresh_run] 'grant report_qa_test'
end
